    ...
    <div>
      ...
      >
        ...
        >
          <div className="relative">
            ...
            <button
              ...
              className="absolute top-1/2 right-3 -translate-y-1/2 text-stone transition-colors hover:text-foreground"
            >
        ...
        <button
          type="submit"
          disabled={!canSubmit}
          className="mt-1 h-10 w-full rounded-md bg-primary text-[14px] font-medium text-primary-foreground transition-colors duration-200 hover:bg-mint-soft disabled:cursor-not-allowed disabled:bg-steel disabled:text-background"
        >
          Continue
        </button>
      </form>
