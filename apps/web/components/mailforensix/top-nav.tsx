      ...
      <header className="sticky top-0 z-40 flex h-12 w-full items-center justify-between border-b border-neutral-200/90 bg-white px-3 sm:px-4 dark:border-neutral-800 dark:bg-[#0E1118]">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <Button
            variant="ghost"
            size="sm"
            className="md:hidden text-neutral-600 dark:text-neutral-400 p-1 h-7 w-7"
        ...
        <div className="flex items-center gap-1 sm:gap-1.5">
          ...
          <Button
            ...
            className="text-neutral-600 hover:text-neutral-900 dark:text-neutral-400 dark:hover:text-neutral-100 p-1.5 h-8 w-8"
          >
          ...
          <DropdownMenu open={isNotificationsOpen} onOpenChange={setIsNotificationsOpen}>
            <DropdownMenuTrigger asChild>
              <Button
                variant="ghost"
                size="sm"
                className="relative text-neutral-600 hover:text-neutral-900 dark:text-neutral-400 dark:hover:text-neutral-100 p-1.5 h-8 w-8"
                title="Security Notifications"
              >
                <Bell className="h-3.5 w-3.5" />
                {activeThreatsCount > 0 && (
                  <span className="absolute top-1 right-1 h-2 w-2 rounded-full bg-red-500 ring-2 ring-white dark:ring-[#0E1118]" />
                )}
              </Button>
            </DropdownMenuTrigger>
            ...
            <DropdownMenuTrigger asChild>
              ...
              >
                <div className="relative">
                  <div className="flex h-6 w-6 items-center justify-center rounded-full bg-emerald-600 text-white font-bold text-[10px] ring-1 ring-neutral-200 dark:ring-neutral-700">
            ...
            <DropdownMenuContent align="end" className="w-64">
              ...
              <div className="px-2 py-1.5 text-[11px] text-neutral-500 dark:text-neutral-400 space-y-1">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-neutral-700 dark:text-neutral-300 font-mono">Active ({activeThreatsCount} Threats)</span>
                </div>
              </div>
              <DropdownMenuSeparator />
