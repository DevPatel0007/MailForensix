...
import { ForensicAnalysis, SenderInfo } from '~/types/mailforensix';
import { Mail, User, Server, Globe, MapPin, Link2 } from 'lucide-react';
...
export function ForensicChain({ analysis, sender }: ForensicChainProps) {
  const steps = [
    ...
    ...(analysis.detectedUrls && analysis.detectedUrls.length > 0 && analysis.detectedUrls[0]
      ? [
          {
