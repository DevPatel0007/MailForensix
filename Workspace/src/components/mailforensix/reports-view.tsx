...
import { BarChart3, Download, ShieldCheck, ShieldAlert, AlertTriangle, CheckCircle2, FileText, Printer } from 'lucide-react';
import { Button } from '../ui/button';
import { toast } from 'sonner';

export function ReportsView() {
  const { emails, activeThreatsCount } = useMail();
  ...
  const handleExportJson = () => {
    const reportData = {
      workspace: 'milapmodi43@gmail.com',
