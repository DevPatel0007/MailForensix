...
import { FolderType, ForensicsViewType } from '../../types';
        ...
        <div className={cn('pt-1 pb-2 border-b border-neutral-200/80 dark:border-neutral-800/80', isCollapsed && 'px-0 text-center')}>
          {!isCollapsed ? (
            <div className="px-1.5 py-1">
              ...
              <p className="text-xs font-medium text-neutral-800 dark:text-neutral-200 truncate mt-0.5" title={INITIAL_CONNECTED_ACCOUNT.email}>
                {INITIAL_CONNECTED_ACCOUNT.email}
              </p>
            </div>
          ) : (
            <div className="flex justify-center py-1" title={`${INITIAL_CONNECTED_ACCOUNT.email} (${isConnected ? 'Connected' : 'Offline'})`}>
